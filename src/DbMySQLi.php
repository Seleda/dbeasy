...
class DbMySQLi extends Db
{
    ...
    public function connect()
    {
        ...
        if (mysqli_connect_error()) {
            throw new \Exception(sprintf('Link to database cannot be established: %s', mysqli_connect_error()));
        }

        // UTF-8 support
        if (!$this->link->query('SET NAMES utf8mb4')) {
            throw new \Exception('PrestaShop Fatal error: no utf-8 support. Please check your server configuration.');
        }
